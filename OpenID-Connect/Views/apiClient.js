...
// ! Duplicated at
// https://github.com/DaniCatGames/jellyfin-openid-connect/blob/main/SSO-Auth/WebResponse.cs#L363-L401
...
var server = await serverAddress({basePath: "/OIDConnectViews"});
...
const current_server = credentials
    .credentials()
    .Servers.find((e) => e.Id === activeServerId) || {};
